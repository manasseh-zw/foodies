    ...
    items: [
      {
        ...
        name: 'Beef Burger',
        price: '$3.00',
        image: '/assets/menu/burger-fries.png',
        tags: ['Popular'],
      },
      {
        id: 'chicken-burger',
      ...
      },
      {
        ...
        name: 'Spicy Wrap',
        price: '$3.00',
        image: '/assets/menu/meat-wrap.png',
        tags: ['Spicy'],
      },
      {
        id: 'hawaiian-wrap',
    ...
    items: [
      {
        ...
        price: '$4.00',
        image: '/assets/menu/chicken-chips.png',
        tags: ['Popular'],
      },
      {
    ...
    items: [
      {
        ...
        price: '$4 - $9',
        image: '/assets/menu/pizza-meat.png',
        tags: ['Popular'],
      },
      {
        id: 'hawaiian-pizza',
      ...
      },
      {
        ...
        name: 'Margherita',
        price: '$4 - $9',
        image: '/assets/menu/pizza-mashroom.png',
        tags: ['Vegetarian'],
      },
    ],
  },
    ...
    items: [
      {
        ...
        price: '$4.00',
        image: '/assets/menu/burger-combo.png',
        tags: ['Value'],
      },
      {
        id: 'chicken-meal',
      ...
      },
      {
        ...
        name: 'Family Feast',
        price: '$25.00',
        image: '/assets/menu/chicken-bucket.png',
        tags: ['Family Size'],
      },
    ],
  },
