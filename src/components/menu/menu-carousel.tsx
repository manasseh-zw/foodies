...
const marqueeItems = [
  'CHECK OUT OUR MENU: WE HAVE DELIGHTFUL BURGERS, CRISPY PIZZAS, AND SAVORY CHICKEN!',
  '•',
  'SAY GOODBYE TO HUNGER WITH OUR FRESHLY PREPARED MEALS',
  '•',
  'EXPLORE OUR VARIETY OF COMBO MEALS AND DEALS',
  '•',
  'FRESH INGREDIENTS DAILY FOR THE BEST TASTE',
  '•',
  'CRAVING SOMETHING DELICIOUS? WE HAVE YOU COVERED!',
  '•',
  'FOODIES - GOOD BITES, GOOD VIBES, GOOD TIMES',
  '•',
  'ORDER NOW FOR FAST DELIVERY TO YOUR DOOR',
  '•',
]
